	...
	return (
		<main className="max-w-4xl mx-auto px-4 py-8">
			<div className="text-cloak-gray font-mono text-sm leading-relaxed mt-4 mb-6">
				...
				<h3 className="text-red-500 font-bold text-md mt-6">
				...
				<h3 className="text-red-500 font-bold text-md mt-2">
					Poseidon Hash
				</h3>
				<p className="text-justify indent-6">
					<strong className="text-red-500">Poseidon</strong> is a modern
				...
				<h3 className="text-red-500 font-bold text-md mt-2">MiMC Sponge</h3>
				<p className="text-justify indent-6">
					<strong className="text-red-500">MiMC Sponge</strong> is another
